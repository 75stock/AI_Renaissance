...
| 开发3组（数据） | 待认领 | 统一封装所有数据源，让 Agent 只管分析不管数据从哪来 |
| 专家1组（财务） | 待认领 | 财报质量七步验证，判断利润是真金白银还是纸面富贵 |
| 专家2组（指标） | 待认领 | 计算量价技术指标，识别趋势和背离信号 |
| 专家3组（资金） | 待认领 | 追踪主力资金流向，发现聪明钱的动向 |
| 专家4组（宏观） | 西西 | 解读利率/汇率/PMI 数据，判断大周期位置 |
| 专家5组（行业） | 云水禅人 | 跟踪产业链景气度和供应链变化，捕捉行业拐点 |
| 专家6组（舆情） | 小皮 | 分析社交情绪和新闻情感，把情绪变成可交易信号 |
| 专家7组（风控） | 待认领 | 识别尾部风险，设定仓位上限，守住不爆仓的底线 |
